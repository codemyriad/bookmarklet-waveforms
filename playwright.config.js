...
const showcaseCapture = Boolean(process.env.SHOWCASE_SCREENSHOT || process.env.JITSI_SCREENSHOT || process.env.TEAMS_SCREENSHOT || process.env.GOOGLE_SCREENSHOT || process.env.README_CAPTURE_DIR)
