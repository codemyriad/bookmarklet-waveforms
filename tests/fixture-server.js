...
const routes = new Map([
	...
	['/assets/elements.0.5.4.opus', ['audio/ogg; codecs=opus', path.join(root, 'site', 'assets', 'elements.0.5.4.opus')]],
	['/assets/elements.0.5.4.mp4', ['audio/mp4', path.join(root, 'site', 'assets', 'elements.0.5.4.mp4')]],
	['/assets/elements-words.json', ['application/json; charset=utf-8', path.join(root, 'site', 'assets', 'elements-words.json')]],
